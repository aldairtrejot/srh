...
function searchInit() {
    ...
    $.ajax({
        url: `${URL_DEFAULT}/coursesnombreacc/table`,
        type: 'POST',
        data: {
        ...
        success: function (response) {
            ...
            if (response.value && response.value.length > 0) {
                response.value.forEach(function (object) {
                    const finalUrl = `/srh/public/coursesnombreacc/edit/${object.id_cat_nombre_accion}`;
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                       ...
                                       <!-- Aquí se agrega la opción para eliminar -->
                                        <a class="dropdown-item" href="#" onclick="confirmDelete(${object.id_cat_nombre_accion})">
...
function renderTable(response) {
    ...
    if (response.value && response.value.length > 0) {
        response.value.forEach((object) => {
            const finalUrl = `${URL_DEFAULT}/coursesnombreacc/edit/${object.id_nombre_accion}`;
            const rowHTML = `
                <tr>
                    <td>
                        <div class="dropdown">
...
function deleteCourse(id) {
    $.ajax({
        url: `${URL_DEFAULT}/coursesnombreacc/delete/${id}`,
        type: 'DELETE',
        data: { _token: token },
        success: () => {
            alert('Nombre de acción eliminado exitosamente.');
            window.location.href = `${URL_DEFAULT}/coursesnombreacc/list`;
        },
