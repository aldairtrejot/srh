...
function searchInit() {
    ...
    $.ajax({
        url: `${URL_DEFAULT}/coursescoordinacion/table`,
        type: 'POST',
        data: {
        ...
        success: function (response) {
            ...
            if (response.value && response.value.length > 0) {
                response.value.forEach(function (object) {
                    const finalUrl = `/srh/public/coursescoordinacion/edit/${object.id_cat_coordinacion}`;
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuIconButton1">
                                       ...
                                       <!-- Aquí se agrega la opción para eliminar -->
                                        <a class="dropdown-item" href="#" onclick="confirmDelete(${object.id_cat_coordinacion})">
...
function renderTable(response) {
    ...
    if (response.value && response.value.length > 0) {
        response.value.forEach((object) => {
            const finalUrl = `${URL_DEFAULT}/coursescoordinacion/edit/${object.id_coordinacion}`;
            const rowHTML = `
                <tr>
                    <td>
                        <div class="dropdown">
...
function deleteCourse(id) {
    $.ajax({
        url: `${URL_DEFAULT}/coursescoordinacion/delete/${id}`,
        type: 'DELETE',
        data: { _token: token },
        success: () => {
            alert('Coordinación eliminada exitosamente.');
            window.location.href = `${URL_DEFAULT}/coursescoordinacion/list`;
        },
