...
$('#openMassUploadModal').on('click', function(e) {
    e.preventDefault(); // Evita la navegación normal
    var url = $(this).attr('href');
    
    $.get(url, function(html) {
        // Eliminar cualquier modal previo insertado, para no duplicar elementos
        $('#massUploadModal').remove();
        // Insertar el HTML del modal obtenido en el body
        var $modal = $(html);
        $('body').append($modal);
        // Mostrar el modal con un efecto de desvanecido (fade in)
