    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response && response.status && response.value) {
                ...
                console.log("Datos recibidos:", data); // Depuración adicional
                ...
                console.log("Nombre:", data.nombre); // Depuración adicional
                console.log("Primer Apellido:", data.primer_apellido); // Depuración adicional
                console.log("Segundo Apellido:", data.segundo_apellido); // Depuración adicional
                console.log("RFC:", data.rfc); // Depuración adicional
