...
$(document).ready(function () {
    ...
    $('select').selectpicker();
    setData();
    setDateLimitsInicioFin();          // ⬅ Establece límites a fechas
    bindValidationInicioFin();         // ⬅ Validación en tiempo real
});

// ==============================
// BLOQUEO de fechas fuera de rango
// ==============================
...
function setCheckboxArea() {
    if ($('#es_por_area').val()) {
        ...
        cleanSelectMoreSelect('#id_usuario_area_aux');
        cleanSelectMoreSelect('#id_usuario_enlace_aux');
    }
}
