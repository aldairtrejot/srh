...
//ROUTE CATALOGO ENTIDAD
Route::get('/entidad/list', EntidadC::class)->name('entidad.list')->middleware('auth');
Route::get('/entidad/create', [EntidadC::class, 'create'])->name('entidad.create')->middleware('auth');
