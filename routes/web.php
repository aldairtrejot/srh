...
Route::get('/letter/delete/{id}', [LetterC::class.'delete'])->name('letter.delete')->middleware('auth');
...
Route::get('/letter/reply/data/{id}', [LetterC::class, 'replyData'])->name('letter.reply.data')->middleware('auth');
