...
<x-template-app.app-layout>
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h5 class="font-weight-normal mb-0">Notas Informativas</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title">Notas Informativas</h4>
    ...
    <script src="{{ asset('assets/js/app/letter/informative/table.js') }}"></script>
    <script src="{{ asset('assets/js/app/letter/cloud/cloud.js') }}"></script>
    <script src="{{ asset('assets/js/app/letter/informative/cloud.js') }}"></script>
