    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <div class="custom-col">
                ...
                <select class="form-control selectpicker" id="id_cat_area_informe" data-live-search="true">
        ...
        <div class="col-12 col-md-6">
            <div class="custom-col">
                ...
                <select class="form-control selectpicker" id="id_cat_date_informe" data-live-search="true">
