...
<x-template-app.app-layout>
                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h5 class="font-weight-normal mb-0">Notas de Requerimiento</h5>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('assets/js/app/letter/request/table.js') }}"></script>
    <script src="{{ asset('assets/js/app/letter/cloud/cloud.js') }}"></script>
    <script src="{{ asset('assets/js/app/letter/request/cloud.js') }}"></script>
