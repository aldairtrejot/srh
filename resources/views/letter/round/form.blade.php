        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <x-template-tittle.tittle-header tittle="Control de correspondencia" caption="Circular" />
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <form id="myForm" action="{{ route('round.save') }}" method="POST" class="form-sample">
                                ...
                                <x-template-form.template-form-input-hidden name="id_tbl_circular"
                                    value="{{ optional($item)->id_tbl_circular ?? '' }}" />
...
<script src="{{ asset('assets/js/app/letter/round/validate.js') }}"></script>