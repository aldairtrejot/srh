            ...
            <div class="card-body">
              ...
              <div>
                <form id="myForm" action="{{ route('letter.save') }}" method="POST" class="form-sample" enctype="multipart/form-data">
                  ...
                  {{-- fecha_captura: backend espera d/m/Y; lo formateamos aquí --}}
                  @php
                    ...
                    <div class="upload-row">
                      ...
                      <div class="upload-col">
                        <div style="display:flex; align-items:center;">
                          ...
                          <input type="file" id="file_anexo_entrada" name="file_anexo_entrada[]"
