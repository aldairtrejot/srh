                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h5 class="font-weight-normal mb-0">Clave</h5>
                        </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title">Clave</h4>
                                @if($coursesMatch ?? true) {{-- para evitar error si no existe --}}
                                    <p class="card-description">
                                        ¿Deseas agregar un registro? 
                                        <a href="{{ route('clave.create') }}" class="text-danger" style="margin-left: 10px;">
...
<!-- CODE SCRIPT-->
<script src="/srh/public/assets/js/app/letter/clave/table.js"></script>
</x-template-app.app-layout>