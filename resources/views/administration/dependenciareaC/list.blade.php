                ...
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h4 class="card-title">Dependencia Área</h4>
                                @if($coursesMatch ?? true) {{-- para evitar error si no existe --}}
                                    <p class="card-description">
                                        ¿Deseas agregar un registro? 
                                        <a href="{{ route('dependenciarea.create') }}" class="text-danger" style="margin-left: 10px;">
...
<!-- CODE SCRIPT-->
<script src="/srh/public/assets/js/app/letter/dependenciarea/table.js"></script>
</x-template-app.app-layout>