                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            ...
                            <h5 class="font-weight-normal mb-0">Coordinacion</h5>
                        </div>
                            ...
                            <div>
                                ...
                                @if($coursesMatch ?? true) {{-- para evitar error si no existe --}}
                                    <p class="card-description">
                                        ...
                                        <a href="{{ route('coordinacion.create') }}" class="text-danger" style="margin-left: 10px;">
...
<!-- CODE SCRIPT-->
<script src="/srh/public/assets/js/app/letter/coordinacion/table.js"></script>
</x-template-app.app-layout>