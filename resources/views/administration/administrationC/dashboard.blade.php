            ...
            <div class="row">
                <div class="col-md-12 grid-margin">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h4 class="card-title">Catálogo Clave</h4>
                                    <a href="{{ route('clave.list') }}" class="btn-icon" title="Ir a Catálogo Clave">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <a href="{{ route('coordinacion.list') }}" class="btn-icon" title="Ir a Catálogo Coordinacion">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h4 class="card-title">Catálogo Entidad</h4>
                                    <a href="{{ route('entidad.list') }}" class="btn-icon" title="Ir a Catálogo Entidad">
                    ...
                    <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                     ...
                     <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                            <div class="card">
                                <div class="card-body text-center">
                                    <h4 class="card-title">Catálogo Tema</h4>
                                    <a href="" class="btn-icon" title="Ir a Catálogo Tema">
                                        <i class="fa-brands fa-themeisle fa-3x"></i>
                                    </a>
                                    <p class="card-text mt-2">Correspondencia</p>
                                </div>
                            </div>
                    ...
                    <br>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <h4 class="card-title">Config Cloud</h4>
                                        <a href="{{ route('configcloud.list') }}" class="btn-icon" title="Ir a Catálogo Área">
