...
<x-template-app.app-layout>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <x-template-tittle.tittle-caption
                            tittle="{{ isset($item->id_cat_tipo_accion) ? 'Modificar' : 'Agregar ' }} Curso Tipo Acción"
                            route="{{ route('coursestipoac.list') }}" />
                        
                        <br>
                       <!--<x-template-tittle.tittle-caption-secon tittle="Información Catalogo Beneficio" />-->

                       <form action="{{ route('coursestipoac.save') }}" method="POST" class="form-sample" id="myForm">
                        @csrf
    ...
    <script src="/srh/public/assets/js/app/courses/coursestipoac/validate.js"></script>
</x-template-app.app-layout>