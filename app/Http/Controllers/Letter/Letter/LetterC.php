...
{
    public function __invoke(){ return view('letter/letter/list'); }

    public function dashboard(){ $item = []; return view('letter/dashboard/dashboard', compact('item')); }
    ...
    public function save(Request $request)
{
    ...
    if (!isset($request->id_tbl_correspondencia)) {
        ...
        // === REGLA: oficio es OBLIGATORIO al CREAR ===
        if (
