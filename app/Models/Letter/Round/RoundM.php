...
class RoundM extends Model
{
    ...
    public function list($iterator, $searchValue, $idUser)
    {
        ...
        $query = DB::table('correspondencia.tbl_circular')
            ...
            ->join('correspondencia.tbl_correspondencia', 'correspondencia.tbl_circular.id_tbl_correspondencia', '=', 'correspondencia.tbl_correspondencia.id_tbl_correspondencia')
