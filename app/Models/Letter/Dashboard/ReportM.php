...
class ReportM extends Model
{
    ...
    public function generateReport($idArea, $idStatus, $isFechas, $fechaInicio, $fechaFin, $idAnio, $allHoras, $inicio, $fin)
    {
        $query = DB::table('correspondencia.tbl_correspondencia')
            ...
            ->leftJoin('administration.users AS user_titular', 'correspondencia.tbl_correspondencia.id_usuario_area', '=', 'user_titular.id')
            ->leftJoin('administration.users AS user_enlace', 'correspondencia.tbl_correspondencia.id_usuario_enlace', '=', 'user_enlace.id')
            ->leftJoin('correspondencia.cat_estatus', 'correspondencia.tbl_correspondencia.id_cat_estatus', '=', 'correspondencia.cat_estatus.id_cat_estatus')
